    ...
    <div className="relative overflow-hidden">
      ...
      <div className="bg-gradient-to-r from-lime-400 to-lime-300 py-16 px-4">
        <div className="container mx-auto text-center relative z-10">
          <div className="absolute -top-8 left-1/4 text-6xl opacity-80 animate-pulse">
            🌈
          </div>
          <div className="absolute -top-4 right-1/3 text-4xl opacity-80 animate-bounce">
            ⭐
          </div>
          <div className="absolute top-8 left-1/3 text-3xl opacity-80 animate-pulse">
            ✨
          </div>
          ...
          <div className="bg-white/90 backdrop-blur-sm rounded-3xl p-6 max-w-2xl mx-auto border-4 border-black shadow-xl transform -rotate-1">
            ...
            <p className="text-gray-800 mt-2 font-medium">
              Make every product uniquely yours with our creative customization
              tools!
            </p>
          </div>
        </div>
        ...
        <div className="absolute top-0 left-0 w-full h-full overflow-hidden">
          <div className="absolute top-10 left-10 w-20 h-20 bg-pink-400 rounded-full opacity-40"></div>
          <div className="absolute bottom-10 right-10 w-16 h-16 bg-purple-400 rounded-full opacity-40"></div>
          <div className="absolute top-1/2 left-20 w-12 h-12 bg-yellow-400 transform rotate-45 opacity-40"></div>
        </div>
      </div>
